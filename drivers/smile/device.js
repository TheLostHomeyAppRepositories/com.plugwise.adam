...
const PlugwiseAnnaDevice = require('../../lib/PlugwiseAnnaDevice');

module.exports = class PlugwiseAnnaSmileDevice extends PlugwiseAnnaDevice {
  ...
  onPoll({ appliance }) {
    // console.log("Smile: ", JSON.stringify(appliance.logs, false, 2));
